<template>
    <div class="amenities-consumables-page">
        <div class="page-header">
            <div>
                <h1 class="page-title">Amenities Consumables</h1>
                <p class="page-subtitle">Manage amenities consumables inventory and supplies</p>
            </div>
            <button 
                ...
                <form @submit.prevent="saveItem" class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            v-model="form.unit" 
                            class="form-control" 
                            placeholder="e.g., pcs, bottles, packets"
                            required
                        />
                    </div>
                    <div class="form-group">
...
export default {
    ...
    setup() {
        ...
        const fetchItems = () => {
            ...
            const bootstrapData = window.__HMS_BOOTSTRAP__?.amenitiesConsumablesItems || [];
        ...
        const saveItem = async () => {
            ...
            try {
                ...
                if (editingItem.value) {
                    ...
                    await window.axios.post(`/api/amenities-consumables-items/${editingItem.value.id}`, data);
                    showSuccess('Item updated successfully!');
                } else {
                    // Create new item
                    await window.axios.post('/api/amenities-consumables-items', data);
        ...
        const deleteItem = async () => {
            ...
            deleting.value = true;
            try {
                await window.axios.post(`/api/amenities-consumables-items/${itemToDelete.value.id}/delete`);
